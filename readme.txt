...
3) Pull country name from returned geocode results and insert it into variable containing NYTimes API url.
4) Check if location is on land. Run code again if false.
5) Request information from NYTimes API.
